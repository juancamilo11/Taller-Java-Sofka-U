...
public class Principal {
    ...
    public static void main(String[] args) {
        String nombre = Utilidades.inputAndValidateName();
        int edad = Utilidades.ingresarYValidarEdad();
        char genero = Utilidades.inputAndValidateGender();
        double peso = Utilidades.ingresarYValidarDecimal("el peso");
        double altura = Utilidades.ingresarYValidarDecimal("la estatura");
        ...
        System.out.println("Para la tercera persona: ");
